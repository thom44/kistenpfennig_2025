        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    '/var/www/kd/kistenpfennig/kistenpfennig_d9/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl',
                );
            } else {
                $template = new Template(
                    '/var/www/kd/kistenpfennig/kistenpfennig_d9/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl',
                );
            }
