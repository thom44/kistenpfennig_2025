...
/**
 * Plugin implementation of the 'course_commerce_add_to_cart' formatter.
 *
 * @FieldFormatter(
 *   id = "course_commerce_add_to_cart",
 *   label = @Translation("WLW Course add to cart form"),
 *   field_types = {
 *     "entity_reference",
 *   },
 * )
 */
class CourseAddToCartFormatter extends FormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    // Loads custom add to cart form for course products.
    $addToCartForm = $this->formBuilder->getForm('Drupal\wlw_course\Form\CourseAddToCartForm', $product_variations);
